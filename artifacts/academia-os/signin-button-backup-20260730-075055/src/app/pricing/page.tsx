    ...
    <div className="min-h-screen bg-[#fffdf7] font-sans antialiased">
      ...
      <div className="px-5 pb-6 sm:px-8">
        <div className="mx-auto flex max-w-7xl justify-center">
          <a
            href="#comparison"
            className="inline-flex items-center justify-center rounded-2xl bg-[#d9a441] px-7 py-4 text-sm font-black text-[#2f1d14] shadow-lg transition hover:bg-amber-400"
          >
            Compare every package feature
          </a>
        </div>
      </div>
      ...
      <section
        id="comparison"
        className="scroll-mt-24 border-y border-slate-200 bg-white px-3 py-16 sm:px-8"
      >
