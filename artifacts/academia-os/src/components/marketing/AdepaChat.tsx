...
function getAdepaReply(rawQuestion: string) {
  ...
  if (/^(hi|hello|hey)(\\s+(there|adepa))?[.!?]*$/.test(question)) {
    return 'Hi too! I am Adepa. How may I help your school today?';
  }
  ...
  if (
    ...
    return `${getTimeGreeting()}! How may I help your school today?`;
  }

  if (
    question.includes('akwaaba') ||
    question.includes('welcome back')
  ) {
    return 'Thank you. How may I help your school today?';
  }
    ...
    setMessages([
      {
        id: 1,
        role: 'adepa',
        text: `${getTimeGreeting()}! I am Adepa, the AcademiaOS website assistant. How may I help your school today?`,
      },
    ]);
  }, []);
      ...
      if (hasOpenedRef.current) {
        setMessages((current) => [
          ...current,
          {
            id: Date.now(),
            role: 'adepa',
            text: 'Akwaaba! How may I help your school today?',
          },
        ]);
      } else {
