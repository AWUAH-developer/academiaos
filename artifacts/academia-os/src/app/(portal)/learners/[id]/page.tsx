...
import { createGuardianPortalAction, updateGuardianContactAction, updateLearnerPhotoAction } from '@/app/actions/learners';
    ...
    <div className="mt-6 grid gap-6 xl:grid-cols-[.7fr_1.3fr]">
      <section className="space-y-6">
        ...
        <div className="paper-card p-5">
          <h2 className="font-black">Learner access</h2>
          <p className="mt-3 text-sm text-slate-600">
            Learners do not require usernames, passwords or portal accounts.
            Their authorised parents, guardians and school staff access the
            appropriate records.
          </p>
        </div>
      </section>
